...
export async function getLauncherToken(username: string, password: string): Promise<OAuthTokenResponse> {
...
export async function exchangeToken(accessToken: string): Promise<OAuthExchangeResponse> {
...
export async function getFortniteToken(exchangeCode: string): Promise<OAuthTokenResponse> {
